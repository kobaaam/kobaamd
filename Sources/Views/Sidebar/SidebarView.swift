    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            GeometryReader { geo in
                ...
                let availableHeight = geo.size.height - todoHeaderHeight - todoBodyHeight - backlinksHeaderHeight - backlinksBodyHeight - tagsHeaderHeight - tagsBodyHeight
